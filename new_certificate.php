                ...
                ';
                            ...
                            <form action="new_certificate.php" method="POST">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input title="Student Index" type="text" name="std_index" class="form-control"
                                        required>

                                    <span class="input-group-append">
                                        <button type="submit" name="check_index"
                                            class="btn btn-info btn-flat">Check!</button>
                                    </span>
                                </div>
                        ...
                        <form action="new_certificate.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden"
                                value="<?php if (isset($student_profile_common))
                                    echo $student_profile_common['stud_id'];
                                else
                                    echo ""; ?>"
                                name="std_index">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (isset($student_profile_common)) { ?>
                                    ...
                                    <input type="text" class="form-control" readonly
                                        value="<?php echo Get_Faculty_Name($student_profile_common['faculty_code']); ?>"
                                        name="faculty">
                                ...
                                <?php } else { ?>
                                    ...
                                    <select title="Student faculty" class="form-control" name="faculty" id="faculty"
                                        required="required">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (isset($student_profile_common)) { ?>
                                    ...
                                    <input type="text" class="form-control" readonly
                                        value="<?php echo Get_Major_Name($student_profile_common['major_code']); ?>"
                                        name="major">
                                ...
                                <?php } else { ?>
                                    ...
                                    <select title="Student major" class="form-control" name="major" id="major"
                                        required="required">
                            ...
                            <div class="card-body">
                                ...
                                <select title="Student nationality" class="form-control" name="nationality" readonly
                                    required="required">
                                    ...
                                    <?php if (isset($student_profile_common)) { ?>
                                        ...
                                        <option value="<?php echo $student_profile_common['nationality_code']; ?>"
                                            selected>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <select title="Certificat type" class="form-control" name="certificate_type"
                                required="required">
                        ...
                        <div class="card-body">
                            ...
                            <input title="Student current semester" type="text"
                                value="<?php if (isset($stud_transcript_sql))
                                    echo $stud_transcript_sql['semester'];
                                else
                                    echo ""; ?>"
                                name="curr_semester" class="form-control" readonly>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input title="Student current CGPA" type="number" name="cgpa"
                                        value="<?php if (isset($stud_transcript_sql))
                                            echo $stud_transcript_sql['cgpa'];
                                        else
                                            echo ""; ?>"
                                        class="form-control" placeholder="CGPA..." readonly>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-8">
                                <input title="Student full name in english" type="text" name="std_full_name_en"
                                    value="<?php if (isset($stud_index) && isset($student_profile_common))
                                        echo $stud_index['stud_name'] . " " . $stud_index['stud_surname'] . " " . $stud_index['familyname'];
                                    else
                                        echo ""; ?>"
                                    class="form-control" placeholder="Student Full Nmae..." required>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-8">
                                <input title="أسم الطالب كامل" type="text" name="std_full_name_ar" class="form-control"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <input title="Student first name" type="text" name="std_first_name_en"
                                        value="<?php if (isset($stud_index) && isset($student_profile_common))
                                            echo $stud_index['stud_name'];
                                        else
                                            echo ""; ?>"
                                        class="form-control" placeholder="First Name..." required>
                                </div>
                                <div class="col-3">
                                    <input title="Student second and third name" type="text" name="std_second_name_en"
                                        value="<?php if (isset($stud_index) && isset($student_profile_common))
                                            echo $stud_index['stud_surname'];
                                        else
                                            echo ""; ?>"
                                        class="form-control" placeholder="Second Name..." required>
                                </div>
                                <!-- <div class="col-3">
                <input type="text" name="std_third_name_en" value="<?php if (isset($stud_index) && isset($student_profile_common))
                    echo $stud_index['stud_name'];
                else
                    echo ""; ?>" class="form-control" placeholder="Third Name..." required>
            </div> -->
                                <div class="col-3">
                                    <input title="Student family name" type="text" name="std_fourth_name_en"
                                        value="<?php if (isset($stud_index) && isset($student_profile_common))
                                            echo $stud_index['familyname'];
                                        else
                                            echo ""; ?>"
                                        class="form-control" placeholder="Family Name..." required>
                                </div>
                            </div>
                        </div>
                        <!-- english name end-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <input title="الاسم الرابع للطالب " type="text" name="std_fourth_name_ar"
                                        class="form-control" placeholder="...الاسم الرابع" required>
                                </div>
                                <!-- <div class="col-3">
                <input type="text" name="std_third_name_ar" class="form-control" placeholder="...الاسم الثالث" required>
            </div> -->
                                <div class="col-3">
                                    <input title="الاسم الثاني و الثالث للطالب " type="text" name="std_second_name_ar"
                                        class="form-control" placeholder="...أسم العائلة" required>
                                </div>
                                <div class="col-3">
                                    <input title="الاسم الاول للطالب " type="text" name="std_first_name_ar"
                                        class="form-control" placeholder="...الاسم الاول" required>
                                </div>
                            </div>
                        </div>
                        <!-- Arabic name end-->
                        ...
                        <div class="card-body">
                            <label for="">Email
                                ...
                                &ensp;&ensp;&ensp; &ensp;&ensp; &ensp;&ensp; &ensp;&ensp; &ensp;&ensp;Mobail</label>
                            <div class="row">
                                <div class="col-5">
                                    <input title="Student email" type="email" name="std_email" class="form-control"
                                        placeholder="name@mail.com" required>
                                </div>
                                <div class="col-5">
                                    <input title="Student phone number" type="tel" name="std_mobail"
                                        class="form-control" placeholder="123-456-7890" required pattern="[0-9]{10}"
