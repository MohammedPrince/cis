...
?>
   ...
   <!DOCTYPE html>
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="include/dist/img/fu.png" alt="Future University Logo" height="250" width="250">
    </div>
...
<form action="index.php" method="POST">
    ...
    <div class="card card-outline card-primary">
        <span class="input-group-icon text-center"><img src="include/dist/img/fu.png" width ="65" height="65" alt=""></span>
