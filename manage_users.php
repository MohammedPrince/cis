    ...
    <div class="content-header">
        ...
        <form action="manage_users.php" method="POST">
                        <div class="card card-info">
                            ...
                            <!-- start Email-->
                             <br><br>
                            <label for="">User Email &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; &ensp; &ensp;&ensp;&ensp; &ensp;&ensp; &ensp;&ensp;&ensp;&ensp; User Type</label>
                                    <div class="row">
                                    <div class="col-4">
                                        <input type="email" name="user_email" class="form-control" placeholder="name@fu.edu.sd..." required>
                                    </div>
                                    <div class="col-4">
                ...
                <tbody>
                    <tr>
                        ...
                        <!-- <td><a class="btn btn-info btn-sm" href="#" class="btn btn-outline btn-info" target="_self">  -->
                            ...
                            <td><a class="btn btn-danger btn-sm" href="manage_users.php?delet_id=<?php  echo base64_encode($row['user_id']);  ?>" onClick="return confirm('Are you sure you want  delete this User ?')"  class="btn btn-outline btn-danger" target="_self">
